      ...
      <div className="bg-white rounded-3xl shadow-2xl flex flex-col md:flex-row max-w-4xl w-full overflow-hidden">
        ...
        <div className="flex-1 p-10 flex flex-col justify-center">
          <div className="mb-8">
            ...
            <p className="text-slate-500 text-base">Register to access all features and insights</p>
          </div>
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            <div>
              <label className="font-medium text-slate-900">Name</label>
              <input
                type="text"
                ...
                required
                className="mt-1 w-full px-4 py-3 rounded-lg border border-slate-200 text-base text-slate-800 focus:outline-none focus:ring-2 focus:ring-indigo-400 placeholder:text-slate-700"
              />
